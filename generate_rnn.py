"""
Filename:     generate_rnn.py
Version:      -
Date:         2018/3/12 (last modified)

Description:  Generates predictions using a character-based LSTM model,
              from saved TensorFlow model files and weight files.
...
Note #2:      Please note self.sentence_length must match the sentence length
              defined in the model file, e.g. the "model.yaml" file generated by 
              "train_rnn.py".
